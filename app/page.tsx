      ...
      <main className="flex flex-col items-center min-h-screen w-full">
        ...
        <div className="bottom w-full relative -mt-0 min-h-78 md:-mt-24">
          <div className="max-w-screen-xl m-auto px-8 md:pt-40 lg:pt-24">
            <div className="flex flex-col w-full items-center mt-32">
              ...
              >
                We aim to drive creativity with a portfolio filled with catchy
                projects
              </motion.h1>
            </div>
        ...
        <div className="w-full">
          <div className="max-w-screen-sm m-auto px-8">
            ...
            >
              Well, this is not going to be your regular long website. You
              already captured what we are all about, so let’s get you into the
              zone. Click on the button to view your next challenge
            </motion.p>
            <motion.div
